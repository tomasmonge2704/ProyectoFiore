...
export default function PurchaseForm() {
  ...
  <CardBody>
    <VStack spacing="10">
        ...
        <GridItem w="100%">
          <VStack spacing="7">
            <InputPersonalizado
              ...
              onChange={(e) => setPurchase({ ...purchase, orderNumber: e.target.value })}
            />
            <InputPersonalizado
              type="text"
              label="SUPPLIER REF. NUMBER"
              value={purchase.supplierRefNumber}
              onChange={(e) => setPurchase({ ...purchase, supplierRefNumber: e.target.value })}
            />
      ...
      <TablePurchase productos={purchase.productos} setProductos={(value) => setPurchase({ ...purchase, productos: value })} />
      <Grid w="100%" templateColumns="repeat(2, 1fr)" gap={5}>
        <GridItem w="100%">
          <VStack spacing="7">
            <InputPersonalizado
              ...
              onChange={(e) => setPurchase({ ...purchase, origin: e.target.value })}
            />
            <InputPersonalizado
              type="text"
              label="PLANT NUMBER"
              value={purchase.plantNumber}
              onChange={(e) => setPurchase({ ...purchase, plantNumber: e.target.value })}
            />
            <InputPersonalizado
              type="text"
              label="BRAND"
            ...
            <InputPersonalizado
              ...
              onChange={(e) => setPurchase({ ...purchase, productionDate: e.target.value })}
            />
            <InputPersonalizado
              type="text"
              label="SHELF LIFE"
              value={purchase.shelfLife}
              onChange={(e) => setPurchase({ ...purchase, shelfLife: e.target.value })}
            />
            <InputPersonalizado
              type="text"
        ...
        <GridItem w="100%">
          <VStack spacing="7">
            ...
            <InputPersonalizado
              ...
              onChange={(e) => setPurchase({ ...purchase, shipmentPeriod: e.target.value })}
            />
            <InputPersonalizado
              type="text"
              label="DELIVERY TERMS"
              value={purchase.deliveryTerms}
              onChange={(e) => setPurchase({ ...purchase, deliveryTerms: e.target.value })}
            />
            <PaymentTerms setPaymentTerms={(value) => setPurchase({ ...purchase, paymentTerms: value })} />
          </VStack>
        </GridItem>
      </Grid>
      <InputPersonalizado
        ...
        onChange={(e) => setPurchase({ ...purchase, exportTo: e.target.value })}
      />
      <Center>
        <Button colorScheme="orange" onClick={saveFormHandler}>Guardar</Button>
      </Center>
    </VStack>
  </CardBody>
</Card>
