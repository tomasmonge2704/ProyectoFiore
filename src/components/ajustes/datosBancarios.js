...
import { ErrorMessage } from "@/utils/mensajeError";
export const DatosBancarios = () => {
  ...
  return (
    <Box mt={2} mb={5} w="full">
      <Grid templateColumns={{ base: "1fr", md: "repeat(2, 1fr)" }} gap={4}>
        {CarteraBancaria?.length &&
      ...
      {CarteraBancaria?.error && 
      <ErrorMessage message={CarteraBancaria.error} />
      }
    </Box>
  );
};
