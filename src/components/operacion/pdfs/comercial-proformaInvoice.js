        ...
        <View style={styles.section}>
          ...
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.empresaRefNumber}</Text>
            </View>
            <View style={styles.grid2}>
          ...
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.buyer.refNumber}</Text>
            </View>
          ...
          <View style={styles.grid}>
            ...
            <View style={styles.grid2}>
              <Text style={styles.textDato}>{fields.empresa.nombre}</Text>
            </View>
          </View>
          <View style={styles.grid}>
            <Text style={styles.text}>{fields.buyer.direccion}</Text>
            <View style={styles.grid2}>
              <Text style={styles.textDato}>{fields.empresa.direccion}</Text>
            </View>
          </View>
          <View style={styles.grid}>
            <View>
            ...
            <View style={styles.grid2}>
              <Text style={styles.textDato}>{fields.empresa.direccion2}</Text>
            </View>
          </View>
          <View style={styles.grid}>
            <View>
            <Text style={styles.text}>{fields.buyer.country}</Text>
            </View>
            <View style={styles.grid2}>
          ...
          <View style={styles.grid}>
            ...
            <View style={styles.grid2}>
              <Text style={styles.textDato}>
                Correspondent Bank:{" "}
                {fields.empresa.bank && fields.empresa.bank.correspondentBank}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.grid}>
            <View style={styles.grid2}>
              <Text style={styles.negrita}>WE CONFIRM HAVING SOLD:</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.vSpacer}></View>
          <View style={styles.tableContainer}>
              ...
              productos.map((prod, index) => (
                <View style={styles.tableRow} key={index}>
                  <View style={styles.borderTable}>
                    {" "}
                    <Text style={styles.textDato}>{prod.netWeight} MT</Text>
                  </View>
                  <View style={{ width: "150%" }}>
                    <View style={styles.borderTable}>
                      {" "}
                      <Text style={styles.textDato}>{prod.description}</Text>
                    </View>
                  </View>
                  <View style={styles.borderTable}>
                    {" "}
                  ...
                  <View style={styles.borderTable}>
                    {" "}
                    <Text style={styles.textDato}>
                      {convertirAMoneda(prod.unitPriceSale * prod.netWeight) ||
                        0}
                    </Text>
                  </View>
                </View>
            ...
            <View style={styles.tableRow}>
              <View style={styles.borderTable}>
                {" "}
                <Text style={styles.textDato}>
                  {convertDecimales(fields.totalNetWeight)} MT
                </Text>
              </View>
          ...
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.productionDate}</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.grid}>
          ...
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.destinationPort}</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.destinationCountry}</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>
                {fields.shipmentPeriodFrom &&
                  transformDate(fields.shipmentPeriodFrom)}
                {fields.shipmentPeriodTo &&
                  ` to ${transformDate(fields.shipmentPeriodTo)}`}
              </Text>
            </View>
            <View></View>
          </View>
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.deliveryTermsSale}</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.grid}>
            <View style={styles.grid2}>
              ...
              <Text style={styles.textDato}>{fields.paymentTermsSale}</Text>
            </View>
            <View></View>
          </View>
          <View style={styles.vSpacer}></View>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.text}>
              {fields.empresa.direccion} {fields.empresa.direccion2} (Tax ID:{" "}
              {fields.empresa.vatNumber})
            </Text>
          </View>
        </View>
      </Page>
